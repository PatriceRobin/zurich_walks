...
knitr::kable(table.zones.typ[0:3],
             align = "cr",
...
```{r plot_difference, results="markup", fig.width = 10, fig.height = 4}
# plot difference of people in the districts -- weekly

ggplot(zwalks.week.knr, aes(fill = difference_people>0, x=week, y=difference_people)) +
  ...
  facet_wrap( ~ knr, scales = "free_y")+
  theme(axis.text.x = element_text(angle = 45))+
  scale_fill_discrete(name = "Peop§le: 2020-2019", labels = c("More in 2019", "More in 2020", "No countings"))+
  theme(legend.position = 'bottom')
```

# Video

In a last step we decided to create a short clip showing the difference of counted pedestrians and cyclists in 2020
...
av::av_encode_video(file_list_sorted$file_path, './Video/Zurich_Walks_Animation.avi', framerate = 3)
